...
namespace cifar {
    ...
    void read_test(std::size_t limit, Images& images, Labels& labels, Functor func) {
        read_test("C:\\Users\\Aybek\\source\\repos\\ml\\x64\\Debug\\cifar-10\\cifar-10-batches-bin", limit, images, labels, func);
    }
    ...
    void read_training(std::size_t limit, Images& images, Labels& labels, Functor func) {
        read_training("C:\\Users\\Aybek\\source\\repos\\ml\\x64\\Debug\\cifar-10\\cifar-10-batches-bin", limit, images, labels, func);
    }
